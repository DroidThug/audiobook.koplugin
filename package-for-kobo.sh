...
for f in main.lua textparser.lua ttsengine.lua highlightmanager.lua synccontroller.lua playbackbar.lua menubuilder.lua btmanager.lua btui.lua btpipeline.lua btmediacontrol.lua utils.lua wavutils.lua piperqueue.lua _meta.lua; do
